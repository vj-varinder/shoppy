...
<div class="banner-top">
	<div class="container">
		<h2 class="animated wow fadeInLeft" data-wow-delay=".5s">Codes</h2>
		<h3 class="animated wow fadeInRight" data-wow-delay=".5s"><a href="index.php">Home</a><label>/</label>Codes</h3>
...
<div class="container">
  ...
  <div class="bs-example wow fadeInDown animated" data-wow-delay=".5s">
    <table class="table">
      <tbody>
        <tr>
  ...
  <div class="bs-example wow fadeInLeft animated" data-wow-delay=".5s" data-example-id="disabled-fieldset">
    <form>
      <fieldset disabled="">
        <div class="form-group">
