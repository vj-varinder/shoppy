...
<div class="banner-top">
	<div class="container">
		...
		<h3 class="animated wow fadeInRight" data-wow-delay=".5s"><a href="index.php">Home</a><label>/</label>Products<label>/</label>Men's</h3>
			...
			<div class="sellers animated wow fadeInLeft" data-wow-delay=".5s">
					...
					<div class="product-go">
						<div class=" fashion-grid">
									<a href="single.php"><img class="img-responsive " src="images/pcc2.jpg" alt=""></a>
							...
							<div class="product-go">
						<div class=" fashion-grid">
									<a href="single.php"><img class="img-responsive " src="images/pcc3.jpg" alt=""></a>
