...
<div class="banner-top">
	<div class="container">
		...
		<h3 class="animated wow fadeInRight" data-wow-delay=".5s"><a href="index.php">Home</a><label>/</label>Checkout</h3>
...
<!-- contact -->
 ...
 <table class="table animated wow fadeInLeft" data-wow-delay=".5s">
		  ...
		  <tr class="cross1">
		  <td class="t-data ring-in"><a href="single.php" class="at-in"><img src="images/pcc2.jpg" class="img-responsive" alt=""></a>
			<div class="sed">
				<h5>Sed ut perspiciatis unde</h5>
			</div>
			<div class="clearfix"> </div>
		  ...
		  <tr class="cross2">
		  <td class="t-data ring-in"><a href="single.php" class="at-in"><img src="images/pcc1.jpg" class="img-responsive" alt=""></a>
			<div class="sed">
				<h5>Sed ut perspiciatis unde</h5>
			</div>
			<div class="clearfix"> </div>
			...
			<td class="t-data">$150.00</td>
			 ...
			 <a href="single.php">Produced By Cart</a>
