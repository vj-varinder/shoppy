			...
			<ul id="flexiselDemo2">
				<li>
					<div class="banner-grid">
						...
						<div class="wome">
							<a href="single.php" >
								<img class="img-responsive" src="images/bi1.jpg" alt="" />
							</a>
				...
				<li>
					<div class="banner-grid">
						<h2>Featured Products</h2>
						<div class="wome">
								<a href="single.php" ><img class="img-responsive" src="images/bi.jpg" alt="" />
								</a>
								<div class="women simpleCart_shelfItem">
									<a href="#"><img src="images/ll.png" alt=""></a>
									<h6 ><a href="single.php">Sed ut perspiciatis unde</a></h6>
					...
					<li>
						<div class="banner-grid">
							<h2>Featured Products</h2>
							<div class="wome">
								<a href="single.php" ><img class="img-responsive" src="images/bi2.jpg" alt="" />
								</a>
								<div class="women simpleCart_shelfItem">
									<a href="#"><img src="images/ll.png" alt=""></a>
									<h6 ><a href="single.php">Sed ut perspiciatis unde</a></h6>
							 ...
							 <!-- start content_slider -->
						       <div id="owl-demo" class="owl-carousel">
					                <div class="item">
											...
											<a href="single.php"><img class="img-responsive" src="images/bb.png" alt="" /></a>
											<a href="single.php" class="shop-2" >Shop Now</a>

					                </div>
									<div class="item">

											<a href="single.php"><img class="img-responsive" src="images/bb1.png" alt="" /></a>
											<a href="single.php" class="shop-2">Shop Now</a>
